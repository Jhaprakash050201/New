    ...
    <>
      ...
      <div className="sticky top-0 z-20">
        <a href="https://promptcareer.in/getstarted/register" target="_blank" rel="noopener noreferrer">
          <div className="flex justify-center items-center py-4 bg-gradient-to-r from-[#134e5e] to-[#71b280] text-white text-lg font-semibold gap-3 shadow-lg cursor-pointer">
